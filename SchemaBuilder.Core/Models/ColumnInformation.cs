using SchemaBuilder.Core.Enums;

namespace SchemaBuilder.Core.Models
{
    public class ColumnInformation
    {
        ...
        public ColumnInformation Guid(bool primaryKey = false, bool foreignKey = false, bool nullable = false, Guid? defaultValue = null)
        {
        ...
        public ColumnInformation Bool(bool primaryKey = false, bool foreignKey = false, bool nullable = false, bool? defaultValue = null)
        {
        ...
        public ColumnInformation Int(Func<ColumnIdentity, ColumnIdentity>? func = null, bool primaryKey = false, bool foreignKey = false, bool nullable = false, int? defaultValue = null)
        {
        ...
        public ColumnInformation String(int size, bool primaryKey = false, bool foreignKey = false, bool nullable = false, string? defaultValue = null)
        {
        ...
        public ColumnInformation Decimal(int precision, int scale, bool primaryKey = false, bool foreignKey = false, bool nullable = false, decimal? defaultValue = null)
        {
            ColumnType = ColumnType.String;
            AddDefaultProperties(primaryKey, foreignKey, nullable, defaultValue);
        ...
        public ColumnInformation DateTime(bool primaryKey = false, bool foreignKey = false, bool nullable = false, DateTime? defaultValue = null)
        {
